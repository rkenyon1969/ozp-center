...
var TableView = React.createClass({
    ...
    renderHeaderColumn: function (type) {
        ...
        if (this.props.sortKey==="name") { nameIcon = <i className="headerSortIcon icon-caret-down-14-white"/>; }
        if (this.props.sortKey==="!name") { nameIcon = <i className="headerSortIcon icon-caret-up-white"/>; }
        if (this.props.sortKey==="owner") { ownerIcon = <i className="headerSortIcon icon-caret-down-14-white"/>; }
        if (this.props.sortKey==="!owner") { ownerIcon = <i className="headerSortIcon icon-caret-up-white"/>; }
        if (this.props.sortKey==="organization") { orgIcon = <i className="headerSortIcon icon-caret-down-14-white"/>; }
        if (this.props.sortKey==="!organization") { orgIcon = <i className="headerSortIcon icon-caret-up-white"/>; }
        if (this.props.sortKey==="status") { statusIcon = <i className="headerSortIcon icon-caret-down-14-white"/>; }
        if (this.props.sortKey==="!status") { statusIcon = <i className="headerSortIcon icon-caret-up-white"/>; }
        if (this.props.sortKey==="updated") { updatedIcon = <i className="headerSortIcon icon-caret-down-14-white"/>; }
        if (this.props.sortKey==="!updated") { updatedIcon = <i className="headerSortIcon icon-caret-up-white"/>; }
        if (this.props.sortKey==="enabled") { enabledIcon = <i className="headerSortIcon icon-caret-down-14-white"/>; }
        if (this.props.sortKey==="!enabled") { enabledIcon = <i className="headerSortIcon icon-caret-up-white"/>; }
        if (this.props.sortKey==="featured") { featuredIcon = <i className="headerSortIcon icon-caret-down-14-white"/>; }
        if (this.props.sortKey==="!featured") { featuredIcon = <i className="headerSortIcon icon-caret-up-white"/>; }
