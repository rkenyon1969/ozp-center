        ...
        return (
            <div className={classes} {...other}>
                <div className="carousel">
                    ...
                    <button className="prev btn hidden" href="#" ref="prev"><i className="icon-caret-left-white"></i></button>
                    <button className="next btn hidden" href="#" ref="next"><i className="icon-caret-right-white"></i></button>
                </div>
            </div>
        );
    },
