                ...
                <div className="container-fluid" id="centered">
                    <div className="navbar-left">
                        <ul className="nav navbar-nav">
                            <li className="tooltiped" data-toggle="tooltip" data-placement="bottom" title="HUD"><a className="lrg" href={HUD_URL}><i className="icon-home-grayLightest"></i><span className="hidden-span">HUD</span></a></li>
                            <li className="active tooltiped" data-toggle="tooltip" data-placement="bottom" title="Center"><a className="lrg" href='#/home'><i className="icon-shopping-grayLightest activeIcon"></i><span className="hidden-span">Center</span></a></li>
                            <li className="tooltiped" data-toggle="tooltip" data-placement="bottom" title="Webtop"><a className="lrg" href={WEBTOP_URL}><i className="icon-layout-grayLightest"></i><span className="hidden-span">Webtop</span></a></li>
                        </ul>
                    </div>
                    ...
                    <div className="navbar-right">
                        <ul className="nav navbar-nav">
                            ...
                            <li className="tooltiped" data-toggle="tooltip" data-placement="bottom" title="Help">
                                <a href="#" onClick={this.showHelpModal}><i className="icon-question-grayLightest"></i><span className="hidden-span">Help</span></a>
                            </li>
                            <li data-toggle="tooltip" data-placement="bottom" title="Menu" className="dropdown user-menu-dropdown tooltiped">
                                <a href="#" className="lrg" data-toggle="dropdown"><i className="icon-menu-grayLightest"><span className="hidden-span">Menu</span></i></a>
