        ...
        return (
            <div className="row resource-card">
                <div className="col-sm-12">
                    ...
                    <Input elementType="input" type="url" requried label="Type of Resource" itemValue={resource.name} />
                    <Input elementType="input" type="url" requried label="URL" itemValue={resource.url} />
                </div>
            </div>
        );
        /*jshint ignore: end */
