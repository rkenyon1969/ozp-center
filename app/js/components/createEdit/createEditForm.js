...
var UrlInput = require('../form/UrlInput');
                ...
                <Content>
                    <Section id="basic-info" title="Basic Information">
                        <div className="col-sm-5">
                            ...
                            <TextInput required setter={setters['title']} defaultValue={listing.title} label="Name" description="Title of the listing" maxLength={256} />
                    ...
                    <Section id="details" title="Details">
                        <div className="col-sm-5">
                            ...
                            <TextInput setter={setters['versionName']} label="Version Number" defaultValue={listing.versionName}
                                    description="Numerical identification of what the release version is" maxLength={256} />

                            <UrlInput required setter={setters['launchUrl']} defaultValue={listing.launchUrl}
                        ...
                        <div className="col-sm-5">
                            ...
                            <UrlInput label="Featured Banner" setter={setters['imageXlargeUrl']} defaultValue={listing.imageXlargeUrl}
                                    description="Must be at least 600px wide x 375px tall." />

                            <UrlInput required label="Small Banner" setter={setters['imageLargeUrl']} defaultValue={listing.imageLargeUrl}
                                    description="Must be at least 220px wide x 137px tall." />

                            <UrlInput required label="Large Icon" setter={setters['imageMediumUrl']} defaultValue={listing.imageMediumUrl}
                                    description="Must be 30px wide x 30px tall." />

                            <UrlInput required label="Small Icon" setter={setters['imageSmallUrl']} defaultValue={listing.imageSmallUrl}
    ...
    renderTypeSelector: function () {
        ...
        return (
            <div className="row type-select">
                <div className="col-sm-5">
                    <Select setter={this.props.setters['type']} label="Listing Type" required defaultValue={listing.type}>
                        {types}
                    </Select>
                </div>
